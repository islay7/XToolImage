...
public:
	...
	bool Decompress(byte* jpeg, uint32 size_in, byte* out, uint32 size_out,
									byte* tables = NULL, uint32 tablesize = 0);
	bool DecompressRaw(byte* jpeg, uint32 size_in, byte* out, uint32 size_out,
									byte* tables = NULL, uint32 tablesize = 0);
};
